...
class AlunoController extends Controller
{
    ...
    */
    public function actionTurma($ano){
        ...
        $alunos = Aluno::find()->where('ano_ingresso='.$ano);
    ...
    /**
    *Mostra o formulário para capturar o ano a ser buscado
    */
    public function actionFormturma(){
            return $this->render('_formTurma');
    }
    ...
    public function actionView($id=0)
    {
        ...
        $qtd_alunos = Aluno::find()->where('ano_ingresso='.$model->ano_ingresso)->count();
